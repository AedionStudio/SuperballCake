...
namespace SceneFusion2 {
    ...
    public:
        ...
        /**
         * Adds a string to the string table if it is not already in the table. Strings in the table will be encoded as
         * uints instead of strings when they occur as property values. You can put frequently occuring string property
         * values in the string table to reduce bandwidth.
         *
         * @param   const sfName& - string
         */
        virtual void AddToStringTable(const sfName& str) = 0;
