...
namespace KS {
    ...
    public:
         ...
         * Static shared pointer constructor
         *
         * @param   const Json::Value& json to construct multitype from.
         * @param   uint8_t type of multitype to construct.
         * @return  SPtr
         */
        INTERNAL static SPtr CreateSPtr(const Json::Value& json, uint8_t type);
         ...
         * @param   uint8_t type of multitype to construct.
         */
        INTERNAL ksMultiType(const Json::Value& json, uint8_t type);
